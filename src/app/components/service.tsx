...
const ServiceSection = () => {
  ...
  return (
    <div
      id="service"
      className="bg-neutral-100 text-neutral-900 px-4 sm:px-6 md:px-20 lg:px-40 py-12"
    >
      {/* Top Section */}
      <div className="mb-10" data-aos="fade-up">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          <div className="flex flex-col max-w-md">
            <p className="text-neutral-600 font-medium text-base md:text-lg">
            ...
            <button
              ...
              className="border-2 border-indigo-600/50 rounded-3xl px-6 py-2 md:px-8 md:py-3 text-sm md:text-lg mt-4 w-fit
        hover:bg-indigo-600 hover:text-neutral-100 transition"
            >
              Learn More
            </button>
          </div>
      ...
      {/* Example services section somewhere below */}
      <div id="services-list" className="mt-20">
        {/* Your services content here */}
      </div>

      {/* Optional Intro */}
      <p className="text-indigo-600/70 max-w-2xl mx-auto mb-12 text-center">
        Delivering creative design and cutting-edge web development to elevate
        your brand and business.
      </p>

      <hr className="border-indigo-600/40" />

      {/* Service Items */}
      <div className="space-y-12 md:space-y-20 mt-10 md:mt-20">
        {/* Brand & Design */}
        <div
          className="w-full min-h-[28rem] flex flex-col md:flex-row items-center gap-8 md:gap-12 lg:gap-20 p-6 rounded-xl border border-indigo-600/50 bg-neutral-200/70"
        ...
        >
          <video
            ...
            loop
            playsInline
            className="w-full md:w-1/2 h-64 sm:h-80 md:h-96 object-contain rounded-xl bg-neutral-300/20"
          />
          <div className="md:pl-6 lg:pl-8 max-w-xl flex flex-col justify-center min-h-[24rem]">
            ...
            <p className="text-neutral-700 font-medium text-sm md:text-base">
              ...
              <span className="text-indigo-600/80 underline">
        ...
        {/* Website & Web App */}
        <div
          className="w-full min-h-[28rem] flex flex-col md:flex-row-reverse items-center gap-8 md:gap-12 lg:gap-20 p-6 rounded-xl border border-indigo-600/50 bg-neutral-200/70"
        ...
        >
          <video
            ...
            loop
            playsInline
            className="w-full min-h-[28rem] md:w-1/2 h-64 sm:h-80 md:h-96 object-contain rounded-xl bg-neutral-300/20"
          />
          <div className="md:pl-6 lg:pl-8 max-w-xl flex flex-col justify-center min-h-[24rem]">
            <p className="text-2xl md:text-3xl lg:text-4xl font-semibold mb-4 md:mb-6">
              Social Media Management
